...
export function addBarycentricCoordinates (bufferGeometry, removeEdge = false) {
  ...
  export function unindexBufferGeometry (bufferGeometry) {
    ...
    /*bufferGeometry.setAttribute("position", new newAttribData[0].attribute.array.constructor(newAttribData[0].array))
    bufferGeometry.setAttribute("normal", new newAttribData[1].attribute.array.constructor(newAttribData[1].array))
    bufferGeometry.setAttribute("uv", new newAttribData[2].attribute.array.constructor(newAttribData[2].array))
*/

    //bufferGeometry.setAttribute(newAttribData)
  };